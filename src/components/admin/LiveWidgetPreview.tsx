...
// applyGlobalFiltersToPreviewData kaldırıldı - widget bazlı filtrelere geçildi
...
export function LiveWidgetPreview({
  ...
  // Global filtreler kaldırıldı - widget bazlı filtrelere geçildi
  ...
  const processedData = useMemo(() => {
    ...
    // 4. Global filtreler kaldırıldı - widget bazlı filtreler kullanılıyor
