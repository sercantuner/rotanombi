...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
  ...
  // Legacy chart widgets removed - these are now created dynamically via Widget Builder
  // grafik_sektor_dagilimi, grafik_kaynak_dagilimi, grafik_ozelkod_dagilimi,
  // grafik_lokasyon_dagilimi, grafik_cari_donusum_trend
  {
